# Análisis de texto: 
# Se solicita crear un programa que permita ingresar un texto, las palabras se encontrarán separadas únicamente por espacios en 
# blanco y el mismo debe finalizar con un punto. En base a ese texto determinar:
